SELECT * FROM mysql_assignment.questions;
...
VALUES
    ...
    ('Q012', 'TM001', 'Participants were receptive and had an attitude towards learning.'),
    ('Q013', 'TM001', 'All participants gained the knowledge and practical skills after this training.'),
    ('Q014', 'TM002', 'The course materials presentation, handson, etc. available for the session cover the entire objectives of the course.'),
